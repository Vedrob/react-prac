function Card(props) {
    return (
        <div className="card">
            ...
            <h1>{props.user}</h1>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Itaque soluta magnam aspernatur repellendus quo reprehenderit assumenda facilis asperiores molestiae aut.</p>
